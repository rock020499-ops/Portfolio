...
-- 1. 燃えるゴミ
INSERT INTO self_disposal_log (main_category, category, quantity, unit, disposal_date, note) VALUES ('燃えるゴミ', '生ゴミ', 26, '袋', '2026-08-12', '10年前の調味料・冷蔵庫の中身など。');
INSERT INTO self_disposal_log (main_category, category, quantity, unit, disposal_date, note) VALUES ('燃えるゴミ', '紙屑（シュレッダー）', 80, '袋', '2026-08-12', '個人情報書類をひたすらシュレッダー。30年以上前の書類も多々あり。');
INSERT INTO self_disposal_log (main_category, category, quantity, unit, disposal_date, note) VALUES ('燃えるゴミ', 'その他', 65, '袋', '2026-08-12', '服・布類・小物類を一気に処分。');
...
-- 6. 紙資源
INSERT INTO self_disposal_log (main_category, category, quantity, unit, disposal_date, note) VALUES ('紙資源', '本', 18, '束', '2026-08-12', 'コミック、文庫本、参考書、地図等120冊以上');
INSERT INTO self_disposal_log (main_category, category, quantity, unit, disposal_date, note) VALUES ('紙資源', '雑誌', 20, '束', '2026-08-12', '十字縛り。重すぎて腰痛に');
INSERT INTO self_disposal_log (main_category, category, quantity, unit, disposal_date, note) VALUES ('紙資源', '新聞・チラシ', 25, '束', '2026-08-12', '数年分溜まった分を一斉処分');
INSERT INTO self_disposal_log (main_category, category, quantity, unit, disposal_date, note) VALUES ('紙資源', '段ボール', 15, '束', '2026-08-12', '特大、大、中、小と大きさが様々を束ねるのに苦労');
